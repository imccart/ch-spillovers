...
3. [Outpatient Claims](data-code/stata-build/_ClaimsOP.do) Mirros the analysis of inpatient claims but for outpatient data. As with the inpatient claims, there are 6 individual code files to process the outpatient claims data. Exports the claims data file, "FinalOutpatientData.dta". 
