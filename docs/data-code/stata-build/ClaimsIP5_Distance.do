/*
Description: This file calculates the distance from each patient to the hospital and
	merges the distance to the collapsed claims data
*/
...
foreach yr in 10 11 12 13 14 15 {
	...
	save "${TEMP}\HospDistance`yr'.dta", replace 
